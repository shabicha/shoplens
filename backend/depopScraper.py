...
# Structure payload.
if CLIPFeatureIdentify.best_brand !="no brand":
  payload = {
      'source': 'universal',
      'url': f"https://www.depop.com/search/?q={CLIPFeatureIdentify.best_colour}+{CLIPFeatureIdentify.best_brand}+{CLIPFeatureIdentify.best_object}",
      "render": "html"
  }
else:
  payload = {
      'source': 'universal',
      'url': f"https://www.depop.com/search/?q={CLIPFeatureIdentify.best_colour}+{CLIPFeatureIdentify.best_object}",
      "render": "html"
  }
